...
| `BYBIT_NETWORK` | No | `main` | Set to `test` to use the testnet, or `demo` for demo trading |
...
- **Test Before You Trade** — Validate your setup on [Bybit Testnet](https://testnet.bybit.com/) before connecting to your live account (set `BYBIT_NETWORK=test` or `BYBIT_NETWORK=demo`)
